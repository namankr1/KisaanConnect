...
public class AdapterQuotes extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView textView5 = (TextView) gridView
                    .findViewById(R.id.address);
            textView5.setText(useraddress[position]);

            TextView textView6 = (TextView) gridView
                    .findViewById(R.id.quoterating);
            textView6.setText(quoterating[position]);
            TextView textView7 = (TextView) gridView
                    .findViewById(R.id.quantity);
            textView7.setText(quotequantity[position]);
            TextView textView8 = (TextView) gridView
                    .findViewById(R.id.nameofseller);
            textView8.setText(username[position]);
            TextView textView9 = (TextView) gridView
